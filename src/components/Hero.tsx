...
export function Hero({ h1, sub, imageSrc, imageSrcMobile, videoSrc, videoPoster, showBadge = true }: Props) {
  ...
  return (
    <section className="relative overflow-hidden min-h-[calc(100vh-120px)] lg:min-h-[calc(100vh-80px)] flex items-center text-white isolate">
      <HeroMedia videoSrc={videoSrc} imageSrc={posterImage} imageSrcMobile={imageSrcMobile} alt={h1} />
