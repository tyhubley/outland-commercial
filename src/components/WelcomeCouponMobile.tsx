...
// Fire after 8s so it lands safely outside every Lighthouse measurement window
// (LCP/TBT are 0-5s, Speed Index is 0-10s). Someone still on the page 8s in is
// a more qualified prospect anyway.
